...
<head>
    ...
    <!-- Fonts END -->
    <!-- Global styles START -->
    <link href="{{ URL::asset('assets/plugins/font-awesome/css/font-awesome.min.css') }}
            " rel="stylesheet">
    <link href="{{URL::asset('assets/plugins/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Global styles END -->

    <!-- Page level plugin styles START -->
    <link href="{{URL::asset('assets/plugins/fancybox/source/jquery.fancybox.css')}}" rel="stylesheet">
    <!-- Page level plugin styles END -->

    <!-- Theme styles START -->
    <link href="{{URL::asset('assets/pages/css/components.css')}}assets/pages/css/components.css" rel="stylesheet">
    <link href="{{URL::asset('assets/corporate/css/style.css')}}" rel="stylesheet">
    <link href="{{URL::asset('assets/corporate/css/style-responsive.css')}}" rel="stylesheet">
    <link href="{{URL::asset('assets/corporate/css/themes/red.css')}}" rel="stylesheet" id="style-color">
    <link href="{{URL::asset('assets/corporate/css/custom.css')}}" rel="stylesheet">
    <!-- Theme styles END -->
</head>
<!-- Head END -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 pre-footer-col">
                ...
                <a class="twitter-timeline" href="https://twitter.com/alanforts" data-tweet-limit="2" data-theme="dark"
                   data-link-color="#57C8EB" data-widget-id="2854074659" data-chrome="noheader nofooter noscrollbar
                   noborders transparent">Loading tweets by @raveapps...</a>
            </div>
            <!-- END TWITTER BLOCK -->
        </div>
    </div>
...
<script src="{{URL::asset('assets/corporate/scripts/back-to-top.js')}}" type="text/javascript"></script>
<!-- END CORE PLUGINS -->

<!-- BEGIN PAGE LEVEL JAVASCRIPTS (REQUIRED ONLY FOR CURRENT PAGE) -->
<script src="{{URL::asset('assets/plugins/fancybox/source/jquery.fancybox.pack.js')}}"
        type="text/javascript"></script><!--
pop up
 -->

<script src="{{URL::asset('assets/corporate/scripts/layout.js')}}" type="text/javascript"></script>
